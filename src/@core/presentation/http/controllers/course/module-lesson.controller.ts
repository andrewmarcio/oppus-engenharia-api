...
import { UpdateCourseModuleDto } from '@domain/course/module/dto/update-course-module.dto'
import { CreateLessonDto } from '@domain/course/module/lesson/dto/create-lesson.dto'
import { CreateManyLessons } from '@domain/course/module/lesson/dto/create-many-lessons.dto'
...
export class ModuleLessonController {
  constructor(private service: ModuleLessonService) {}
